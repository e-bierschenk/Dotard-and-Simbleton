...
export const findBusiness = (searchString) => {

  const foundBusn = businesses.find((business) => {
    return business.companyName.toLowerCase().includes(searchString)
  })
...
export const findAgent = (searchString) => {
    const foundAgent = getAgents().find((agent) => {
    return agent.fullName.toLowerCase().includes(searchString)
  })
